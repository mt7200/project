...
@Service("InsertDepartmentComponent")
@BixComponentPackage(dirname = "system/ai", type = "SYSTEM")
public class InsertDepartmentComponent extends ABaseComponent {
    @Autowired
    private SystemManagerStrategyFactory strategyFactory;

    @Override
    @WebRemote(paramsType = {"data", "json"})
    @Component(name = "InsertDepartmentComponent", memo = "新增组织", type = "data")
    ...
    public Object run(Map param) {
        strategyFactory.getDepartmentManager().createDepartment(
