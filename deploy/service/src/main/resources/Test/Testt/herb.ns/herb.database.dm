    ...
    <database id="herb" description="" >
        <![CDATA[
            ...
            <sqlMap namespace="herb">
                ...
                <!-- 中药材表 - herb                                               -->
                <!-- ============================================================ -->
                <database id="list" description="查询药材列表（分页）">
                    <![CDATA[
                ...
                <database id="count" description="查询药材总数">
                    <![CDATA[
                        SELECT COUNT(*)
                        FROM herb
                        WHERE 1=1
                ...
                <database id="detail" description="根据ID查询药材详情">
                    <![CDATA[
                        SELECT id, name, category, nature, taste, meridian, min_dosage, max_dosage, unit, is_toxic, functions, indications, created_at, updated_at
                        FROM herb
                        WHERE id = #{id}
                ...
                <database id="insert" description="新增药材">
                    <![CDATA[
                ...
                <database id="update" description="修改药材信息">
                    <![CDATA[
                        UPDATE herb
                        SET name = #{name},
                            category = #{category},
                ...
                <database id="delete" description="删除药材">
                    <![CDATA[
                ...
                <!-- ============================================================ -->
                <database id="incompatibilityList" description="查询配伍禁忌列表">
                    <![CDATA[
                ...
                <database id="incompatibilityInsert" description="新增配伍禁忌">
                    <![CDATA[
                        INSERT INTO herb_incompatibility (herb_a_id, herb_b_id, type, detail)
                        VALUES (#{herbAId}, #{herbBId}, #{type}, #{detail})
                    ]]>
                </database>
                <database id="incompatibilityUpdate" description="修改配伍禁忌">
                    <![CDATA[
                ...
                <database id="incompatibilityDelete" description="删除配伍禁忌">
                    <![CDATA[
                ...
                <!-- 方剂表 - formula                                              -->
                <!-- ============================================================ -->
                <database id="formulaList" description="查询方剂列表（分页）">
                    <![CDATA[
                ...
                <database id="formulaCount" description="查询方剂总数">
                    <![CDATA[
                        SELECT COUNT(*)
                        FROM formula
                        WHERE 1=1
                ...
                <database id="formulaDetail" description="根据ID查询方剂详情">
                    <![CDATA[
                        SELECT id, name, category_l1, category_l2, functions, indications, modifications, source, created_at, updated_at
                        FROM formula
                        WHERE id = #{id}
                ...
                <database id="formulaInsert" description="新增方剂">
                    <![CDATA[
                ...
                <database id="formulaUpdate" description="修改方剂信息">
                    <![CDATA[
                        UPDATE formula
                        SET name = #{name},
                ...
                <database id="formulaDelete" description="删除方剂">
                    <![CDATA[
                ...
                <!-- ============================================================ -->
                <database id="formulaHerbList" description="查询方剂药材明细">
                    <![CDATA[
                ...
                <database id="formulaHerbDelete" description="删除方剂药材关联">
                    <![CDATA[
                        DELETE FROM formula_herb WHERE id = #{id}
                    ]]>
                </database>
                <database id="formulaHerbBatchDelete" description="批量删除方剂药材关联">
                    <![CDATA[
