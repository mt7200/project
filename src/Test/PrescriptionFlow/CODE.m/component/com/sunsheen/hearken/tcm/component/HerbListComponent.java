...
@Service("HerbListComponent")
@BixComponentPackage(dirname = "tcm/prescription", type = "BIZ")
public class HerbListComponent extends ABaseComponent {

    @Override
    @WebRemote(paramsType = {"data", "json"})
    @Params(@ParamItem(name = "data", type = "json"))
    @Component(name = "HerbListComponent", memo = "药材列表/搜索查询", type = "data")
    public Object run(Map param) {
        ...
        List<Map<String, Object>> list = executeSelect("herb/list", params);
        long count = executeSelect("herb/count", params);
